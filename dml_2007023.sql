...
insert into Customer(customer_id, first_name, last_name, date_of_birth, address, contact_number)values(13, 'Ariful', 'Islam', TO_DATE('2023-05-30', 'YYYY-MM-DD'), 'Telegati, Khulna', '5623-9912');
